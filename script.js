...
function handleFormSubmit() {
    ...
    // TAB-PROBLEM VON IMPORTANT-INPUTS ÜBERSPRINGEN
document.addEventListener("DOMContentLoaded", function() {
    // Setze das tabindex für Honeypot-Felder auf -1, damit sie beim Tabben übersprungen werden.
    ...
    document.addEventListener("keydown", function(event) {
        if (event.shiftKey && event.key === "Tab") {
            ...
            if (currentIndex > 0) {
                // Wenn Shift + Tab gedrückt wird, gehe zum vorherigen Nicht-Honeypot-Element
